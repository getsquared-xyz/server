...
var leet={a:["4"],b:["8","l3","i3","13"],c:[],d:[],e:["3"],f:["ph"],g:["6","9"],h:[],i:"1",j:[],k:[],l:"(i|1|l)",m:[],n:[],o:["0"],p:[],q:["o","9"],r:["12"],s:["5"],t:["7"],u:["(i|1|l)_(i|1|l)"],v:[],w:["VV","uu"],x:["ecks"],y:["4","j","7"],z:["2","s"]};
function cleanUp(text){
    for(var i = 0; i < badwords.length; i++){
        if(new RegExp(badwords[i].split("").map(function(el){return "(" + leet[el.toLowerCase()].join("|") + ")"}).join(""), "i").test(text)){
